...
// Action class for retrieving a user by their user id.
// In practive this just redirects to retrieving a user by their nick, it's 
// here for compatability reasons, but we might look into removing this at
// some point to reduce the amount of stuff we have to support.
class UserbyidAction extends ShowstreamAction
{
   // -------------------------------------------------------------------------
   // Function: doPreparation
   // Redirect the target to the lookup by name
   //
   // Returns:
   // o void
