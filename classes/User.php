...
class User extends Managed_DataObject
{
   ...
   // -------------------------------------------------------------------------
   // Function: getProfile
   // Returns the profile associated with a user
   //
   // Returns:
   // o profile Profile
   //
   ...
   // -------------------------------------------------------------------------
   // Function: sameAs
   // Checks if this user's profile is the same as another's
   ...
   // Returns the user on the server with a given nickname
   //
   // Error States:
   // o throws NoSuchUserException if a user is not found with that nickname
   ...
   // Returns true/false whether the user is subscribed to the specified other
   // profile
   ...
   // Returns true/false whether user has a subscription pending to the specified
   // other profile
   ...
   // -------------------------------------------------------------------------
   // Function: getCarrier
   // Returns the carrier used by a user for SMS notifications if one is
   // specified (null if not)
    function getCarrier()
    {
      ...
      if (Event::handle('StartUserRegister', array($profile))) {
         ...
         if (!empty($welcome)) {
            ...
            if (empty($welcomeuser)) {
               ...
               sprintf(_('Welcome to %1$s, @%2$s!'), common_config('site', 'name'), $profile->getNickname()), 'system');
            }
         }
   ...
   // Returns boolean true/false as to whether this user is a mutual subscriber
   ...
   // Finds the mutually-subscribed users of a user
   function mutuallySubscribedUsers() {
   ...
   // -------------------------------------------------------------------------
   // Function: getReplies
   // Display x amount of replies to a user
   ...
   // Display x amount of tagged notices of a user's
   ...
   // ------------------------------------------------------------------------
   // Function: getNotices
   // Display x amount of notices from a user
   ...
   // -------------------------------------------------------------------------
   // Function: block
   // Add a block record for this user for a given other profile
   //
   // Returns:
   // o boolean success
   function block(Profile $other) {
      ...
      if ($this->id == $other->id) {
         common_log(LOG_WARNING,
            sprintf("Profile ID %d (%s) tried to block themself.", $this->id, $this->nickname));
         return false;
      }
   ...
   // -------------------------------------------------------------------------
   // Function: unblock
   // Remove a block record for this user of a given other profile
   ...
   // -------------------------------------------------------------------------
   // Function: isMember
   // Returns true/false whether a user is member of a given group
   ...
   // -------------------------------------------------------------------------
   // Function: isAdmin
   // Returns true/false whether a user is an admin of a given group (bit of a
   // misleading name in that regard...)
   ...
   // -------------------------------------------------------------------------
   // Function: getGroups
   // Returns all the usergroups that this user is a member of (up to $limit if
   // specified)
   ...
   // Returns an array of profiles this user is subscribed to
   ...
   // -------------------------------------------------------------------------
   // Function: getScubscribers
   // Returns an array of profiles that subscribe to this user
   ...
   // Returns an array of profiles that this user is subscribed to and possess
   // a given peopletag
   ...
   // Returns an array of profiles that subscribe to this user and possess a
   // given peopletag
   ...
   // -------------------------------------------------------------------------
   // Function: hasRight
   // Returns boolean true/false whether a user has a specified right
   ...
   // Helper function for user deletion that deletes all tags created by this
   // user.
   function _deleteTags() {
      $tag = new Profile_tag();
      $tag->tagger = $this->id;
   ...
   // Helper function for user deletion that deletes all block records created
   // by this users.
   function _deleteBlocks() {
      $block = new Profile_block();
      $block->blocker = $this->id;
   ...
   // -------------------------------------------------------------------------
   // Function: hasRole
   // Returns true/false whether the user has a given role
   ...
   // Returns true/false whether this user is sandboxed or not
   function isSandboxed() {
   ...
   // -------------------------------------------------------------------------
   // Function: isSilenced
   // Returns true/false whether this user is banned (silenced) or not
   function isSilenced() {
   ...
   // Returns true/false as to whether this user receives email noticifications
   //
   ...
   // Returns the first $limit notices that the user posted and was repeated,
   // starting at $offset.
   ...
   // -------------------------------------------------------------------------
   // Function: repeatedToMe
   // Returns the first $limit notices directly mentioning a user that were
   // repeated, starting at $offset
   ...
   // -------------------------------------------------------------------------
   // Function: siteOwner
   // Returns an account that is the site owner
   ...
   // Send a password-recovery email for the user
   ...
   // Returns if the user has stream-only mode enabled (old-school setting)
   function streamModeOnly() {
   ...
   // Returns if the user has stream nicknames enabled (old-school setting)
   function streamNicknames() {
      if (common_config('oldschool', 'enabled')) {
         $osp = Old_school_prefs::getKV('user_id', $this->id);
         if (!empty($osp)) {
   ...
   // Creates and returns an ActivityVerb (ostatus 0.5) of a registration.
   function registrationActivity() {
      $profile = $this->getProfile();
   ...
   // Returns true/false whether an account is private
   ...
   // Returns true/false whether an account has a password
   ...
   // -------------------------------------------------------------------------
   // Function: delPref
   // Delete a preference record for a user
   ...
   // -------------------------------------------------------------------------
   // Function: getPref
   // Returns a preference record for a user
   ...
   // Returns a configuration preference for a user
   ...
   // -------------------------------------------------------------------------
   // Function: setPref
   // Sets a user preference record for a user
