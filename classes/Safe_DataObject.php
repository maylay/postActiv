...
// ============================================================================
// Class: Safe_DataObject
// Extended DB_DataObject to improve a few things:
// o free global resources from destructor
// o remove bogus global references from serialized objects
// o don't leak memory when loading already-used .ini files
//   (eg when using the same schema on thousands of databases)
class Safe_DataObject extends GS_DataObject {
   ...
   //
   // Returns:
   // o true or PEAR:error on wrong paramenters.. or false if no file exists..
   ...
   //
   // Parameters:
   // o array of .ini file names $schemas
   //
   // Returns:
   // o array
