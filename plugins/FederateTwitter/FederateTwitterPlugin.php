...
class FederateTwitterPlugin extends Plugin {
   function onPluginVersion(array &$versions)
   {
      $versions[] = array('name' => 'Federate Twitter',
         'version' => '0.1',
         'author' => 'Maiyannah Bishop',
         'homepage' => 'https://www.postactiv.com',
         'rawdescription' => _m('A prototype plugin to better extend postActiv federation with Twitter.'));
      return true;
   }
}
?>